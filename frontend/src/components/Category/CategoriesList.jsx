...
import { deleteCategoriesApi, listCategoriesApi } from "../../services/categories/categoryService";
...
const CategoriesList = () => {
  ...
  //!deleting
  const{mutateAsync,isSuccess,isPending,error:categoryerr}=useMutation({
    mutationFn: deleteCategoriesApi,
    mutationKey:["deletecategory"]
  })
  const handleDelete=(id)=>{
    mutateAsync(id).then((data)=>{refetch()}).catch((err)=>console.log(err))
  }
  return (
